...
?>
	<a href="pengaturan.php" class="list-group-item-action ripple text-light" aria-current="true"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
