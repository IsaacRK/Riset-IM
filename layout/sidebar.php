...
<nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
     <ul class="nav sidebar-nav">
       ...
       <div class="sidebar-brand">
        <div class="flex-column align-items-star py-0">
		<div class="row">
         
			<div class="col-sm col-5 align-self-center mt-3">
				<a href='Profile.php'><img src='Photo/<?php echo$Foto_05; ?>' class='profile'></a>
			</div>
			<div class="namasz col-sm col-6 text-center align-self-center mt-3">
                <a href='Profile.php'>
