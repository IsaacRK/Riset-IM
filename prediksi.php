		...
		<table class="table">
			...
			<tbody>
				...
				foreach($arr as $data){
					...
					//pengembilan total ambil dalam 7 hari
					$predStok = '';
					$x = 0;
					$total = 0;
					...
					//jika rata rata lebih dari nilai akhir maka, nilai naik
					//jika rata rata kurang dari nilai akhir maka, nilai turun
					$x = $total;
					if($total != 0){
						$x = ceil($total / $hari);
					}
					...
					//tabel harga_history
					$sqlHharg = "select * from harga_history where stock_id = $sid and date > CURRENT_DATE - INTERVAL $hari day";
